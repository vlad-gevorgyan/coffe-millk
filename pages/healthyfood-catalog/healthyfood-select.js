let select = function () {
  const cardItems = document.querySelectorAll(".healthyfood-card"),
  prices3 = document.querySelectorAll(".healthyfood-price3"),
...
selects.forEach((item, idx) => {
  item.addEventListener("change", () => {
    ...
    const price1 = cardItems[idx].querySelector(".healthyfood-price1");
